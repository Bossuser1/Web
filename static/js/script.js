...
var childItem = $('<li><a href="index.html"><i class="fa fa-circle-o"></i> Ansible</a></li>' +
    '<li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Django</a></li>' +
'<li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> ReactJs</a></li>');
